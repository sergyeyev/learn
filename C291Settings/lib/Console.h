...
class Console {
public:
	static const int ScreenWidthDefault = 120;
	static const int ScreenHeightDefault = 40;
	...
	static short Width();
	static short Height();
	static void SetScreen(const short Width = ScreenWidthDefault, const short Height = ScreenHeightDefault);
};
